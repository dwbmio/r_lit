...
pub fn pick_h264_encoder(pref: EncoderPreference) -> Result<EncoderChoice, GamereelError> {
...
fn libx264_choice() -> Result<EncoderChoice, GamereelError> {
