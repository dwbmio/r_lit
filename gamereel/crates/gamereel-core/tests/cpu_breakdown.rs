//! Diagnostic: where does the CPU time go in a gamereel-core render?
//!
//! Not a regression test — this prints a phase-by-phase timing
//! breakdown. Run with `cargo test --release -p gamereel-core --test
...
fn cpu_breakdown_perf_main() {
    ...
    rt.block_on(async {
        ...
        println!();
        println!("CPU breakdown for 300-frame 720x1080 gamereel-core render:");
