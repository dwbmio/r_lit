...
#   * Real gamereel-core `perf_main` end-to-end (composition + scaling +
...
# ---------- 3) gamereel-core perf_main end-to-end ----------
echo
echo "gamereel-core perf_main end-to-end:"
...
cat > "$RESULTS_DIR/m1.json" <<JSON
{
  ...
  "notes": [
    ...
    "gamereel-core median is end-to-end including per-frame CPU compositing — dominant cost until M4.",
